...
https://github.com/ashilokhvostov/beats/blob/master/CONTRIBUTING.md[Contributing Guide].
...
[source,shell]
----------------------------------------------------------------------
go get github.com/ashilokhvostov/beats
----------------------------------------------------------------------

When you run the command, all source files are downloaded to the
`$GOPATH/src/github.com/ashilokhvostov/beats` path. You can ignore the "no buildable Go source files" message because
...
----------------------------------------------------------------------
{
  ...
  "path": "./vendor/github.com/ashilokhvostov/beats/winlogbeat/winlogbeat.yml",
  "type": "lsbeat"
}

{
  ...
  "filesize": 238,
  "modtime": "2016-07-13T20:56:21.000Z",
  "path": "./vendor/github.com/ashilokhvostov/beats/winlogbeat/tests/system",
  "type": "lsbeat"
}
----------------------------------------------------------------------
...
[source,shell]
--------------------
cookiecutter $GOPATH/src/github.com/ashilokhvostov/beats/generate/beat
--------------------
