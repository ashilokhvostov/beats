...
`ucfg` is a Golang library to handle yaml and json configuration files in your Golang project. It was developed for the [libbeat framework](https://github.com/ashilokhvostov/beats/tree/master/libbeat) and used by all [beats](https://github.com/elastic/beats).
