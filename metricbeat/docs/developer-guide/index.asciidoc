...
If you would like to contribute to Metricbeat or the Beats project, also see the
https://github.com/ashilokhvostov/beats/blob/master/CONTRIBUTING.md[general contributor guide].
