...
https://godoc.org/github.com/ashilokhvostov/beats/libbeat/common#MapStr[MapStr API docs].
...
https://godoc.org/github.com/ashilokhvostov/beats/metricbeat/schema[schema] package
