...
https://github.com/ashilokhvostov/beats/blob/master/packetbeat/CONTRIBUTING.md[CONTRIBUTING]
file on GitHub.
...
* In the `$GOPATH/src/github.com/ashilokhvostov/beats` folder, add your fork
...
in the https://github.com/ashilokhvostov/beats[Beats GitHub repository].
...
`beats/libbeat/publisher` directory in the https://github.com/ashilokhvostov/beats[Beats GitHub repository].
...
added (see the `beats/libbeat/common` package in the https://github.com/ashilokhvostov/beats[Beats GitHub repository]).
...
`beats/libbeat/common` module in the https://github.com/ashilokhvostov/beats[Beats GitHub repository].
...
in the https://github.com/ashilokhvostov/beats[Beats GitHub repository]. The
